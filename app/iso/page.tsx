      ...
      <div style={pageShellStyle}>
        ...
        <section style={{ ...cardStyle, padding: "1.25rem 1.15rem 1.35rem", display: "grid", gap: 14 }}>
          <div style={{ display: "grid", gap: 8 }}>
            ...
            <h1 style={{ margin: 0 }}>ISO</h1>
            <p style={{ margin: 0, maxWidth: 640, color: "#cbd5e1", lineHeight: 1.65 }}>
              This placeholder is ready for us to build out the ISO search flow, request intake, listing views, and whatever retrieval or tracking tools you want to hang off it.
            </p>
          </div>
          ...
          >
            {[
              "Search and browse requests",
              "Submission flow for new items",
