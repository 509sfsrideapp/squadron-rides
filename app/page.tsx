...
function createHomepageStatusScenario(): HomepageStatusScenario {
  ...
  const responsePool: WeightedStatusLine[] = [
    ...
    { value: `RESPONSE_THREAD_SYNC//CHANNEL:${chooseRandom(HOMEPAGE_STATUS_CHANNELS)}//STATUS:CURRENT`, weight: 6 },
    { value: `RIDE_SIGNAL_CHECK//TYPE:${chooseRandom(HOMEPAGE_STATUS_RIDE_SIGNALS)}//RESULT:${chooseRandom(["LOCKED", "WEAK", "STABLE"])}`, weight: 7 },
    { value: `MODULE_BOOT_OK//TARGET:${chooseRandom(HOMEPAGE_STATUS_MODULES)}//LATENCY:${randomInt(12, 96)}MS`, weight: 7 },
    { value: `ALERT_POSTURE_SET//SECTOR:${sector}//LEVEL:${chooseRandom(HOMEPAGE_STATUS_ALERT_STATES)}`, weight: 6 },
    { value: `INBOX_THREAD_RECONCILE//THREAD:${chooseRandom(HOMEPAGE_STATUS_THREADS)}//STATE:CLEAN`, weight: 6 },
    { value: `EVENT_UPLINK_STABLE//SOURCE:MULTI//TRACKING:TRUE`, weight: 6 },
    { value: `MAP_ROUTE_RESOLVE//SECTOR:${sector}//ERROR_MARGIN:${(Math.random() * 1.2 + 0.2).toFixed(1)}%`, weight: 6 },
    { value: `POST_REVIEW_QUEUE//COUNT:${randomInt(0, 5)}//STATUS:${chooseRandom(["OPEN", "STABLE", "CLEAR"])}`, weight: 5 },
    { value: `DEVICE_TOKEN_CHECK//CHANNEL:${chooseRandom(HOMEPAGE_STATUS_CHANNELS)}//STATUS:${chooseRandom(["BOUND", "MISSING", "STALE"])}`, weight: 5 },
    { value: `QUEUE_LATENCY_AUDIT//STATE:${chooseRandom(HOMEPAGE_STATUS_QUEUE_STATES)}//DELAY:${randomInt(18, 140)}MS`, weight: 5 },
