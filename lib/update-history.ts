...
export const UPDATE_HISTORY: UpdateHistoryEntry[] = [
  ...
  {
    commit: "v398",
    title: "Admin New-User Notifications",
    summary: "Added an automatic admin notification on account creation so every authorized admin account now gets a New User alert with the new member's name as soon as signup completes.",
  },
  {
    commit: "v397",
  ...
  {
    commit: "v373",
    title: "One-Time Startup Runtime Guard",
    summary: "Hardened the startup access-sequence gate with a runtime-level one-shot guard so the secure app-opening sequence is consumed once per live app session and no longer replays when navigating back to the homepage from other areas of the app.",
  },
  {
    commit: "v372",
  ...
  {
    commit: "v361",
    title: "Homepage Status Weight Tuning",
    summary: "Increased the homepage app-status console weight for the INITIATE_POST_CHECK line so that post-check status messages appear more often in the rotating tactical console feed.",
  },
  {
    commit: "v360",
    title: "Post-Ride Follow-Up Notifications",
    summary: "Added automatic Notifications inbox check-ins for both riders and drivers after a ride is completed, with optional comment boxes that do not require a response and still mark as read as soon as the message is opened.",
  },
  {
    commit: "v359",
  ...
  {
    commit: "v335",
    title: "Wider Message Bubble Layout",
    summary: "Expanded the usable width of direct-message bubbles and trimmed the thread pane side padding so short replies can stretch farther across the conversation instead of wrapping into narrow stacked lines too early.",
  },
  {
    commit: "v334",
